...
/**
 * Get service branch display name
 */
export function getServiceBranchDisplay(branch: string): string {
...
/**
 * Get service branch emoji
 */
export function getServiceBranchEmoji(branch: string): string {
